...
<?php
  if(isset($_POST['Approve']))
  {
    $pID = $_GET['id'];
      ...
      $sql = "update financialdata set status='Approve' where payment_id='$pID'";
...
<!-- <form action="Financial_Record.php" method="post">
  <table align="center" style="border:2px hidden;" cellspacing="20">
  <caption style= "font-size:30px"> Approve Trancation </caption>
  <tr>
  <th align="left" width="250" style="border:hidden;font-size:20px">Payment id: </th>
...
$sqlshow2= "SELECT financialdata.payment_id, alumniinfo.pi_name,financialdata.status, financialdata.payment_purpose, financialdata.payment_date, financialdata.total_payment, financialdata.reciept FROM alumniinfo, financialdata
			WHERE alumniinfo.pi_register = financialdata.pi_register and financialdata.status='Not Approve'";
...
while ($row = mysqli_fetch_assoc($resultfin))
{
  ...
  echo "<td> 
          <form method='POST' action='Financial_Record.php?id=".$row['payment_id']."'>
