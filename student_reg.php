...
if(isset($_REQUEST['register']))
{
	...
	else
	{
		...
		$register_sql = "INSERT INTO studentmember (pi_register, al_password, al_status) 
		VALUES ('$registration', '$password', '$al_status')";

		if ($conn->query($register_sql) === TRUE) 
		{
			$register_sql = "INSERT INTO studentinfo (pi_name,pi_gender,pi_register,pi_branch,pi_session,pi_email,pi_mobile) 
		...
		else 
		{
			...
			header("refresh:10;url=register2.html" );
		}
	}
}
?>
