...
if(isset($_POST['update']))
{
	...
	else
	{
		...
		// {
			...
			$sql1 = "update studentinfo set street='$street',pin='$pin',hName='$hname',pi_district = '$district', pi_state='$state', pi_picture = '$pp'  where pi_register = '$userid' ";
