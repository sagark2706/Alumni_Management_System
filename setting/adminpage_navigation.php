...
<ul class="ul1">
    ...
    <div class="dropdown">
    <li class="li1"><a href="#"><span class="span1">Financial</span></a></li>
		<div class="dropdown-content">
    		<a href="Financial_Record.php">Approve Payment</a>
			<a href="PaymentDetails.php">Payment Details</a>
   		</div>
    </div>

	<div class="dropdown">
    <li class="li1"><a href="#"><span class="span1">Expert Class</span></a></li>
		<div class="dropdown-content">
    		<a href="expertClass.php">Request Expert Class</a>
			<a href="ApproveExpertClass.php">Expert Classes</a>
   		</div>
    </div>
	<div class="dropdown">
