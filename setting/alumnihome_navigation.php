...
<ul class="ul1">
  ...
  <div class="dropdown">
    <li class="li1"><a href="NewPayment.php"><span class="span1">Payment</span></a></li>
</div>
    <div class="dropdown">
    <li class="li1 active"><a href="alumni_home.php"><span class="span1">My Profile</span></a></li>
    <div class="dropdown-content">
    		<a href="update_profile.php">Update Profile</a>
        <a href="alumniJobDetails.php">Job</a>
   		</div>
    ...
    <div class="dropdown">
    <li class="li1"><a href="expertClassApprove.php"><span class="span1">Expert Talk</span></a></li>
    </div>
