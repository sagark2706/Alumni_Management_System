...
<body bgcolor="white">
<div>
<img src="image/homeimage.jpg" width="100%" height="200px" />
</div>
<table class="table">
<tr>
<td>
<ul class="ul1">
	<div class="dropdown">
	<li class="li_image"><img src="image/cape.jpeg" width="55px" height="50px" style="padding-right:15px" /></li>
    </div>
    <div class="dropdown">
    ...
    <div class="dropdown">
  	<li class="li1"><a href="#"><span class="span1">Register</span></a></li>
    	<div class="dropdown-content">
    		<a href="register.html">Alumni Register</a>
    		<a href="register2.html">Student Register</a>
   		</div>
    </div>
    <!-- <li class="li2"><a href="register.html"><span class="span1">Alumni Register</span></a></li>
    <li class="li2"><a href="register2.html"><span class="span1">Student Register</span></a></li> -->
